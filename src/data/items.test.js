...
describe('carrier definitions', () => {
  it('baskets hold solids, buckets hold liquids', () => {
    ...
    // two raw ingredients at the house stove, sold like jam/flour. rawSugar/sugarCube
    // added with #227 — raw sugar is a bought-in pantry staple (not gathered), sugar
    // cubes the cooked dish (raw sugar + water), a horse treat.
    expect(CARRIER_DEFS.basket.accepts).toEqual(['hay', 'apple', 'carrot', 'seed', 'catFood', 'bunnyFood', 'foxFood', 'duckFood', 'egg', 'eggBrown', 'wool', 'yarn', 'compost', 'strawberry', 'wheat', 'honey', 'jam', 'flour', 'pigFeed', 'blueberry', 'potato', 'orange', 'berry', 'vegetableStew', 'berryPie', 'honeyBread', 'rawSugar', 'sugarCube']);
