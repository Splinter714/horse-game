...
export default class PaddockScene
  extends WithWorld(WithWildlife(WithRaccoon(WithAmbientEvents(WithCatAI(WithBunny(WithCharm(WithCreatures(WithFlock(WithHerd(WithFarmStand(WithDayNight(WithWeather(WithHorseAI(WithBehaviors(WithRiding(WithPlayer(
