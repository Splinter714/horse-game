...
export const WithInteractables = (Base) => class extends Base {
  buildInteractables() {
    ...
    this.interactables = [gate, house, shop, barn, gardenPlant, trough, catFoodBowl, catWaterBowl, sources, nests, farmStand, spinningWheel, compostBin, gardenHarvest];
    ...
    this.toolWorld     = [trough, catFoodBowl, catWaterBowl, sources, nests, farmStand, spinningWheel, compostBin, gardenHarvest];
  }
