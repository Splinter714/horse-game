// The Horse model is now a thin specialization of the generic Animal (./Animal.js),
// configured by the 'horse' species definition (./species/index.js). All the needs/
// decay/care/mood logic lives in Animal; this file keeps the Horse name and the
