...
try {
  ...
  const dataUrl = await page.evaluate(({ keys, SCALE }) => {
    ...
    const ORDER = ['idle_0','idle_1','idle_content_0','idle_content_1','idle_neglected_0','idle_neglected_1','walk_0','walk_1','walk_2','walk_3','eat_0','eat_1','roll_0','roll_1','roll_2','roll_3','wallow_0','wallow_1','lay_0','lay_1','sleep_0','sleep_1','nap_0','nap_1','pounce_0'];
