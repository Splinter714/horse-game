...
export const WithInteractables = (Base) => class extends Base {
  buildInteractables() {
    ...
    this.interactables = [gate, house, shop, barn, gardenPlant, trailCollectible, trough, catFoodBowl, catWaterBowl, bunnyFoodBowl, bunnyWaterBowl, seedFeeder, nectarFeeder, beehive, sources, nests, farmStand, standWoolDump, spinningWheel, kitchenCounter, compostBin, trashCan, gardenHarvest, neighborGift, neighborTrade];
