...
export const WithDuck = (Base) => class extends Base {
  ...
  // as waddling in from outside the frame rather than appearing near the pile. Picks
  // the next untaken sex (nextDuck, among the ducks already in the roster, #409) and
  // remembers it on the wild-duck record so the commit spawns the SAME sex/key it's
  // been waddling around as — the look is continuous through the commit.
  _spawnWildDuck(x, y) {
