...
describe('carrier definitions', () => {
  it('baskets hold solids, buckets hold liquids', () => {
    ...
    expect(CARRIER_DEFS.basket.accepts).toEqual(['hay', 'apple', 'carrot', 'seed', 'catFood', 'bunnyFood', 'foxFood', 'duckFood', 'egg', 'eggBrown', 'wool', 'yarn', 'compost', 'strawberry', 'wheat', 'honey', 'jam', 'flour', 'pigFeed', 'blueberry', 'potato', 'vegetableStew', 'berryPie', 'honeyBread']);
