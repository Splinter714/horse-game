...
export const WithInteractables = (Base) => class extends Base {
  buildInteractables() {
    ...
    this.interactables = [gate, house, shop, barn, trough, catFoodBowl, catWaterBowl, sources, nests, farmStand, spinningWheel, compostBin];
    ...
    this.toolWorld     = [trough, catFoodBowl, catWaterBowl, sources, nests, farmStand, spinningWheel, compostBin];
  }
